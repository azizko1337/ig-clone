...
" alt="Polub"><?php }?></button><a class="post__button" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('action'=>(("comment/").($_smarty_tpl->tpl_vars['post']->value["id"]))),$_smarty_tpl ) );?>
