    ...
    <article class="post">
        <div class="post__header">
            ...
            {if $post["user_id"]==(\core\SessionUtils::load("id", true)) || \core\RoleUtils::inRole("moderator")}
                <a href="{url action="edit_post" post_id={$post["id"]}}" class="post__more-options">
                    <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
        ...
        <div class="post__footer">
            <div class="post__buttons">
                ...
                <a class="post__button" href="{url action=("comment/"|cat:$post["id"])}">
            ...
            <div class="post__infos">
                <div class="post__likes">
                    <span
                    ><b class="post__name--underline" id="{$post["id"]}likes">{$post["likes"]}</b> likes, <b class="post__name--underline" id="{$post["id"]}comments">{$post["comments"]}</b> comments
                </div>
                ...
                <span class="post__date-time">Zapostowano {$post["createdAt"]}</span>
            </div>
        </div>
    </article>
{/strip}
